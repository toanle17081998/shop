                        ...
                        <div class="card-body">
                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.menu.stote') }}" method="post" novalidate="novalidate">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="content-menus" name="content" type="text" class="form-control" rows="6"></textarea>
